...
execute if score #xh_bool xh_find matches 1 at @s run summon item_display ~ ~ ~ {Tags:["xh","xh_display"],transformation:{left_rotation:[0f,0f,0f,1f],right_rotation:[0f,0f,0f,1f],translation:[0f,0.5f,0f],scale:[1f,1f,1f]},item:{id:"minecraft:vex_spawn_egg",count:1,components:{"minecraft:custom_model_data":228014}}}
